...
namespace RazorViewRender.Domain.ViewRenderService
{
	public class ViewRenderingService : IViewRenderingService
	{
		...
		{
			return await RenderWithModel(viewPath, string.Empty);
		}

		public async Task<string> RenderWithModel<TModel>(string viewPath, TModel model)
		{
		...
		{
			var getViewResult = _viewEngine.GetView(null, viewPath: viewName, isMainPage: true);
